...
var ADMIN_USER = 'shunji';        /* ← 改成你要的帳號 */
var ADMIN_PASS = 'shunji2026';    /* ← 改成你要的密碼（★ 務必改掉）*/
...
function pub(){
  ...
  }catch(e){ return { price:{}, sold:{}, img:{}, hidden:{} }; }
}
function local(){
  try{
...
window.SJ_ADMIN = {
  data     : readOv,
  isSold   : function(n){ return !!readOv().sold[n]; },
...
function paintSold(){
  ...
  Object.keys(ov.sold).forEach(function(nm){
    if(!ov.sold[nm]) return;
